---
name: supabase-postgres-best-practices-community
description: Community-curated best practices for Supabase and Postgres from the Antigravity Awesome Skills collection.
---
# Supabase Postgres Best Practices (Community)
(Extended rules for performance and security)
