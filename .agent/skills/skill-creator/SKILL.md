---
name: skill-creator
description: Framework for creating or updating AI agent skills with concrete instructions and examples.
---
# Skill Creator
Guidelines for developing effective AI agent skills:
1. Define clear name and description.
2. Provide concrete usage examples.
3. Organize related scripts/assets.
4. Maintain SKILL.md manifest.
